...
public class DialogViewModel : BaseViewModel
{
    ...
    private string _systemPromptString = string.Empty;
    ...
    public DialogViewModel(ILLMModel model)
    {
        _model = model;
    }
    ...
    public ICommand SendRequestCommand => new ActionCommand((async o =>
    {
        ...
        try
        {
            var response = await Model.GetClient().SendRequest(this.Dialog, PromptString, SystemPromptString);
