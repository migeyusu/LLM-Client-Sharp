...
public class DialogViewModel : BaseViewModel
{
    ...
    public bool IsKeyEnterCommandEnable
    {
        get => _isKeyEnterCommandEnable;
        set
        {
            if (value == _isKeyEnterCommandEnable) return;
            _isKeyEnterCommandEnable = value;
            OnPropertyChanged();
...
#pragma warning restore CS0162 // 检测到不可到达的代码
    ...
    private bool _isKeyEnterCommandEnable;
