...
public class OpenAIO1 : AzureClientBase
{
    ...
    public OpenAIO1(AzureEndPointBase endpoint, AzureModelInfo modelInfo) : base(endpoint, modelInfo)
    {
    }

    public override IChatClient CreateClient(AzureOption endpoint)
    {
