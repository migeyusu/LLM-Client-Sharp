...
/// 文本模型
/// </summary>
public class AzureTextClientBase : AzureClientBase
{
    ...
    public AzureTextClientBase(AzureEndPointBase endpoint, AzureModelInfo modelInfo) : base(endpoint, modelInfo)
    {
    }
}