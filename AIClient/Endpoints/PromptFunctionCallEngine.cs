...
public abstract class FunctionCallEngine
{
    ...
    public abstract void Initialize(ChatOptions options, ILLMChatModel model,
...
public class DefaultFunctionCallEngine : FunctionCallEngine
{
    ...
    public override void Initialize(ChatOptions options, ILLMChatModel model, IList<ChatMessage> chatMessages)
    {
