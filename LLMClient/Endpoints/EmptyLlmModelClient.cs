...
#endif
        var str = "This is a stub response from StubLlmClient. It is used for testing purposes. The content can be streamed in chunks if streaming is enabled in the parameters.";
